...
},function(e,t){},function(e,t){},function(e,t){},function(e,t){e.exports="'use strict';\n\nonmessage = function onmessage(_ref) {\n  var data = _ref.data;\n  var fn = data.fn,\n      env = data.env;\n  var xMax = env.xMax,\n      yMax = env.yMax,\n      snake = env.snake,\n      point = env.point;\n\n  var values = [];\n\n  try {\n    var heuristicFn = eval('(function() {' + fn + '; return heuristic; })();');\n\n    for (var y = 0; y < yMax; y++) {\n      values[y] = [];\n\n      for (var x = 0; x < xMax; x++) {\n        values[y][x] = heuristicFn(x, y, xMax, yMax, snake, point);\n\n        if (isNaN(parseInt(values[y][x]))) {\n          postMessage({\n            action: 'error',\n            error: '[' + x + ',' + y + '] returned \"' + values[y][x] + '\". This is not a number'\n          });\n        }\n      }\n    }\n  } catch (error) {\n    /* eslint-disable no-console */\n    console.error(error);\n    /* eslint-enable no-console */\n\n    postMessage({\n      action: 'error',\n      error: error.message\n    });\n  }\n\n  postMessage({\n    action: 'complete',\n    values: values\n  });\n};"},function(e,t,n){(function(t){function n(){if(t.Blob)try{return new Blob(["asdf"],{type:"text/plain"}),Blob}catch(e){}var e=t.WebKitBlobBuilder||t.MozBlobBuilder||t.MSBlobBuilder;return function(t,n){var i=new e,r=n.endings,s=n.type;if(r)for(var o=0,a=t.length;o<a;++o)i.append(t[o],r);else for(var o=0,a=t.length;o<a;++o)i.append(t[o]);return s?i.getBlob(s):i.getBlob()}}e.exports=n()}).call(t,n(24))},function(e,t){var n;n=function(){return this}();try{n=n||Function("return this")()||(0,eval)("this")}catch(e){"object"==typeof window&&(n=window)}e.exports=n},function(e,t,n){"use strict";function i(){h.play.removeAttribute("disabled"),h.pause.removeAttribute("disabled"),h.reset.removeAttribute("disabled"),h.start.setAttribute("disabled",""),h.step.removeAttribute("disabled")}function r(){h.play.setAttribute("disabled",""),h.pause.setAttribute("disabled",""),h.reset.setAttribute("disabled",""),h.start.removeAttribute("disabled"),h.step.setAttribute("disabled","")}n(7),n(8);var s=n(2),o=n(3),a=n(4),l=n(6),c=n(5),u={average:document.getElementById("js__average"),canvas:document.getElementById("js__canvas"),console:document.getElementById("js__console"),editor:document.getElementById("js__editor"),points:document.getElementById("js__points"),score:document.getElementById("js__score")},h={play:document.getElementById("js__play"),pause:document.getElementById("js__pause"),reset:document.getElementById("js__reset"),start:document.getElementById("js__start"),step:document.getElementById("js__step")},d=new s(u.canvas),f=new a(u.editor),g=new o(u.console),p=new l(u.average,u.points,u.score,d),m=new c(d,f,g,p);h.start.addEventListener("click",function(){i(),m.start()}),h.reset.addEventListener("click",function(){r(),m.reset()}),h.play.addEventListener("click",function(){return m.play()}),h.pause.addEventListener("click",function(){return m.pause()}),h.step.addEventListener("click",function(){return m.step()})}]);